<?php
    ...
    class Session {
        ...
        public function __construct() {
            ...
            $stmt = $pdo->prepare('SELECT session_id, updated_at, salt_token, user_id, uniq_info, browser, ip FROM sessions WHERE                            session_id = :sid AND uniq_info = :info AND updated_at > :updated AND ip = :ip AND browser = :browser');
        ...
        function newSession() {
            ...
            $stmt = $pdo->prepare('INSERT INTO sessions (session_id, updated_at, salt_token, user_id, uniq_info, browser, ip)
